...
UM.Dialog
{
    ...
    Column
    {
        ...
        TextEdit
        {
            text: "{printer_name}, {printer_name_full}, {printer_type}, {printer_type_full}, " +
                  "{layer_height}, {machine_nozzle_size}, {infill_sparse_density}, {speed_print}, " +
                  "{profile_name}, {profile_name_full}, {material_name}, {material_name_full}, " +
